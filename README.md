...
> **⚠️ 과제 제출용 프로젝트입니다.** <br>
> **⚠️ 실행 초반 자료 수집을 위한 딜레이가 있을 수 있습니다. Gemini 서버 일시적 과부하로 인한 오류가 있을 수 있습니다.**
...
> 첫 실행 시 별도 수집 없이 바로 데이터를 확인할 수 있습니다.
...
1. **RAG 기반 초안 품질 향상** — 서울신문 기사 아카이브를 벡터 DB에 인덱싱하여 서울신문 문체에 맞는 초안 생성
